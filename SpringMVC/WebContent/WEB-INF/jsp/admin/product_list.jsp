...
// 				return;
	...
	function jumpNormalPage(page){
		...
		if(page<1 |page >totalPage)
			...
			{
		$("#submitForm").attr("action", "product_list?page=" + page).submit();
			}
	}
					...
					<table class="table" cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
						<tr>
							...
							<tr>
								...
								<td><input type="checkbox" name="IDCheck" value="${product.productID}" class="acb" /></td>
								...
								<td>
									<a href="product_edit?productID=${product.productID}" id="edit" class="edit">编辑</a> 
									<a href="javascript:del(${product.productID});">删除</a>
								</td>
							</tr>
						</c:forEach>
